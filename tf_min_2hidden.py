...
weights3 = tf.Variable(tf.random_normal([hidden_num,1],stddev = 0.1,seed = 3),name = 'weights3')
biases3 = tf.Variable(tf.constant(init_bias,shape=[1,1]),name = 'biases3')
# biases3 = tf.Variable(tf.constant(0.0,shape=[1,1]),name = 'biases3')
...
y_ = tf.add(tf.matmul(hidden_out2,weights3),biases3)
